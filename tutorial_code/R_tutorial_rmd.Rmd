...
*The following chapter will walk you through using **ggplot2**, an R package that allows you to make graphs in R. If you are already familiar with R/ggplot2 and want to skip ahead, go straight to the exercises - labeled 'Data Visualization: Exercises 1/2/3'.* 

*The following text is all excerpted from the free online textbook,* **R for Data Science (2e)**, *chapter 1, 'Data visualization'. Exercises and some text have been adjusted for brevity.*   
