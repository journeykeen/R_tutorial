...
You, the student, should follow along. I will be placing the exact code and output for these notes in this document, but you should produce the code yourself to verify that you get the same output.
...
file_name = "/data/percentiles_combined.csv"
